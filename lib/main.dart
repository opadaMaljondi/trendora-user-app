...
if(Firebase.apps.isEmpty) {
  if(Platform.isAndroid) {
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyDSpEoJENIFJu8iYJatKP14oagVq8Ul9e8",
        projectId: "trendora-d65d5",
        messagingSenderId: "645471674999",
        appId: "1:645471674999:android:cf20ab4faea85fbeda9c72"
    ));
  }else{
