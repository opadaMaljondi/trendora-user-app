...
class _CustomExpansionTileState extends State<CustomExpansionTile> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(covariant CustomExpansionTile oldWidget) {
    ...
    final ThemeData theme = Theme.of(context);
    final ExpansionTileThemeData CustomExpansionTileTheme = ExpansionTileTheme.of(context);
    final Object defaults = theme.useMaterial3
        ? _CustomExpansionTileDefaultsM3(context)
        : _CustomExpansionTileDefaultsM2(context);
  ...
  void _updateShapeBorder(ExpansionTileThemeData CustomExpansionTileTheme, ThemeData theme) {
    _borderTween
      ...
      ..end = widget.shape
          ...
          ?? Border(
            top: BorderSide(color: theme.dividerColor.withOpacity(0)),
            bottom: BorderSide(color: theme.dividerColor.withOpacity(0)),
          );
  }
...
class _CustomExpansionTileDefaultsM2 extends ExpansionTileThemeData {
  _CustomExpansionTileDefaultsM2(this.context);
...
class _CustomExpansionTileDefaultsM3 extends ExpansionTileThemeData {
  _CustomExpansionTileDefaultsM3(this.context);
