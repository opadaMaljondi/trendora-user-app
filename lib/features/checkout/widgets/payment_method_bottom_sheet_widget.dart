  ...
  Widget build(BuildContext context) {
    return Consumer<CheckoutController>(
      builder: (context, checkoutProvider, _) {
        return Container(constraints : BoxConstraints(maxHeight: MediaQuery.of(context).size.height * 0.7,
                ...
                child: SingleChildScrollView(
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                      ...
                      _isPaymentMethodsAvailable(Get.context!, checkoutProvider) ?
                      Column(crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisSize: MainAxisSize.min, children: [
                          ...
                          if(Provider.of<SplashController>(context, listen: false).configModel != null &&
                              ...
                              Provider.of<SplashController>(context, listen: false).configModel?.paymentMethods != null &&
                              Provider.of<SplashController>(context, listen: false).configModel!.paymentMethods!.isNotEmpty)
...
bool _isPaymentMethodsAvailable(BuildContext context, CheckoutController checkoutProvider){
  ...
  bool isOfflinePaymentMethodsOn =checkoutProvider.offlinePaymentModel!=null&&checkoutProvider.offlinePaymentModel!.offlineMethods != null && checkoutProvider.offlinePaymentModel!.offlineMethods!.isNotEmpty;
