...
import '../../../helper/otp_less_service.dart';
...
class _ProfileScreen1State extends State<ProfileScreen1> {
  ...
  final OtpLessService _otpLessService = OtpLessServiceImpl();
  File? file;
      ...
      child: Scaffold(
        ...
        body: Consumer<AuthController>(builder: (context, authController, _) {
          return Consumer<ProfileController>(builder: (context, profile, _) {
            if (!isFirstTime) {
              if( profile.userInfoModel!.lName==null||profile.userInfoModel!.lName==''){
                List<String> name=profile.userInfoModel!.fName!.trim().split(" ");
                        ...
                        CustomTextFieldWidget(
                          ...
                          suffixIcon: (isPhoneChanged ||
                              ...
                              : config?.customerVerification?.phone == 1 &&
                                  ...
                                  : Images.verifiedSvg,
                          suffixOnTap: () async {
                            await _otpLessService.callOtpLess(onReceiveResult:
                                (token, phoneNumber, errorMessage,
                                    countryCode) async {
