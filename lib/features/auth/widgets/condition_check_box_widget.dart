                ...
                SizedBox(width : 20, height : 20,
                  child: Container(alignment: Alignment.center,
                      ...
                      child: Icon(CupertinoIcons.checkmark_alt,size: 15,
                          color: authController.isAcceptTerms? Theme.of(context).primaryColor.withOpacity(.75): Colors.transparent))),
              ]),
            ),
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Text(getTranslated('terms_condition', context)!, style: textMedium.copyWith(
                  fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor.withOpacity(0.8),
