      ...
      Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text.rich(
          TextSpan(
            children: [
              TextSpan(
                text: "${getTranslated('market', context)!} ",
                style: textRegular.copyWith(
                  fontFamily:'impact' ,
                  fontSize: Dimensions.fontSizeOverLarge,
                  color:  Theme.of(context).primaryColor, // Change to match the logo color
                ),
              ),
              TextSpan(
                text: getTranslated("east", context)!,
                style: textRegular.copyWith(
                  fontSize: Dimensions.fontSizeOverLarge,
                  fontFamily:'impact' ,
                  color: Color(0xff1c476f), // Change to match the logo color
                ),
              ),
            ],
          ),
...
,
        Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall),
            child: Text(getTranslated('slogan', context)!,style: textRegular.copyWith(fontSize: Dimensions.fontSizeSmall,fontFamily: 'impact')))]),
