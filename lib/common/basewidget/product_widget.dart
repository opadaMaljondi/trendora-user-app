  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(onTap: () {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall), border: Border.all(color: Theme.of(context).primaryColor.withOpacity(.10), width: 1),
